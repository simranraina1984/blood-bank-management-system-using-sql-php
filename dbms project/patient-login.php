...
<body>
        ...
        <center><h1> Patient Login </center>
            <br><br><br>
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td width="100px" height="50px"><a href='patient-registration.php'> dont have an account? Register here</a></td>
                </tr>
            </table>
            </form>
</div>
        ...
        if(isset($_POST['sub']))
        {
            $un=$_POST['un'];
            $ps=$_POST['ps'];
            $q=$db->prepare("SELECT * FROM patients WHERE name='$un' && Password='$ps'");
            $q->execute();
            $res=$q->fetchAll(PDO::FETCH_OBJ);
            if($res)
            {
                $_SESSION['Uname']=$un;
               echo  header("location:patient-home.php");
