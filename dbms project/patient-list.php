    ...
    <center> <div id="form">
        <table>
            <tr>
                ...
                <td><center><b>Patient Id</center></td>
                <td><center><b>Patient Name</center></td>
                <td><center><b>Patient Email</center></td>
                <td><center><b>mobile no.</center></td>
        
            </tr>
            
            <?php
            $q=$db->query("SELECT *  FROM patients");
            while($r1=$q->fetch(PDO::FETCH_OBJ))
            {
                ?>
                <tr>
                    <td><center><b><font color="black"><?=$r1->PID; ?></center></td>
